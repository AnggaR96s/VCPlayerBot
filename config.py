...
class Config:
    ...
    # Exclusive for heroku vars configuration.
    SUDO = [int(admin) for admin in (ADMIN).split()]
    # group admins will be appended to this list.
    ...
    try:
        ...
        if CUSTOM_QUALITY > 100:
            CUSTOM_QUALITY = 100
            LOGGER.warning(
                "maximum quality allowed is 100, invalid quality specified. Quality set to 100")
